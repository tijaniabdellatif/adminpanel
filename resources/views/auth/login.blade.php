            ...
            <div class="leading-loose">
                <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" method="POST" action="{{route('login')}}">
                    ...
                    <div class="">
                        ...
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded @error('email') border border-red-500 @enderror" id="email" name="email" type="email"  placeholder="email" aria-label="username" value="{{old('email')}}">
                    </div>
                    ...
                    <div class="mt-2">
                        ...
                        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded @error("password") border border-red-500 @enderror" id="password" name="password" type="password"  placeholder="*******" aria-label="password">
                    </div>
                    ...
                    <div class="mt-4 items-center justify-between">
                        <input class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded cursor-pointer clickable" type="submit" value="Log in" />
                        <a class="inline-block right-0 align-baseline  font-bold text-sm text-500 hover:text-blue-800 cursor-pointer" href="#">
                            Forgot Password?
                        </a>
                    </div>

                    <a class="inline-block right-0 align-baseline font-bold text-sm text-500 hover:text-blue-800 cursor-pointer" href="{{route('register')}}">
                        Not registered ?
                    </a>
                </form>
